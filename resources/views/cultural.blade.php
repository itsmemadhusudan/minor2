      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ route('cultural') }}">Cultural</a>
                </li>
          ...
          <button type="button" class="logout"><a href="login.html" style="text-decoration: none;color: white;">Log Outs</a></button>
        </div>
      </div>
    </nav>
    <div class="space"> </div>
    <div class="row row-cols-1 row-cols-md-4 g-4">
      <div class="col-lg-3 col-md-6">
        <div class="card h-100 custom-card">
          <a href="popup.html">
            <img src="cultural1.png" class="card-img-top" alt="...">
        </a>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="card h-100 custom-card">
          <a href="popup.html">
            <img src="cultural3.png" class="card-img-top" alt="...">
        </a>
          <div class="card-bottom-overlay">
            <p class="card-text">Manish Malhotra<br/>Lehenga</p>
          </div>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="card h-100 custom-card">
          <a href="popup.html">
            <img src="cultural4.png" class="card-img-top" alt="...">
        </a>
          <div class="card-bottom-overlay">
            <p class="card-text">Manish Malhotra<br/>Lehenga</p>
          </div>
